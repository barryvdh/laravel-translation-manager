...
<div style="width: 90%; margin: auto;">
    ...
    <table id="translationDatatable" class="table table-bordered">
        <thead>
        <tr>
            <th width="15%">Key</th>
        ...
        <?php foreach($translations as $key => $translation): ?>
            <tr id="<?= $key ?>">
                ...
                <?php if($deleteEnabled): ?>
                    <td align="center">
                        <a href="<?= action('\Barryvdh\TranslationManager\Controller@postDelete', [$group, $key]) ?>" class="btn btn-danger btn-xs delete-key" data-confirm="Are you sure you want to delete the translations for '<?= $key ?>?" title="delete" alt="delete"><span class="glyphicon glyphicon-trash"></span></a>
                    </td>
                <?php endif; ?>
            </tr>
        <?php endforeach; ?>
