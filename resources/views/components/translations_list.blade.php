...
<table class="table">
    ...
    <tr id="<?php echo htmlentities($key, ENT_QUOTES, 'UTF-8', false) ?>">
        <td><?php echo htmlentities($key, ENT_QUOTES, 'UTF-8', false) ?>
            <a href="<?php echo action('\Barryvdh\TranslationManager\Controller@getDetail', [$group, $key]) ?>" ><span class="glyphicon glyphicon-new-window"></span></a>
        </td>
        <?php foreach ($locales as $locale): ?>
